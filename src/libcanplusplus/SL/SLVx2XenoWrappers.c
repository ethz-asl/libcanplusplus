/*!
 * @file 	SLVx2XenoWrappers.c
 * @author 	Christian Gehring
 * @date 	Feb, 2012
 * @version 1.0
 * @ingroup robotCAN, SharedMemory
 * @brief
 * Copied from SL_vx2xeno_wrappers.c (Stefan Schaal, Oct. 2009)
...
#include "SLDefines.hpp"

#ifdef USE_SL_FUCNTIONS
#include "utility.h"
#else
#include "SLUtility.h"
#endif
...
{
  printf("removeSharedMemoryAtExit() is not from SL\n");
  int dummy=-1;
...
{
	printf("removeSharedMemory() is not from SL\n");
